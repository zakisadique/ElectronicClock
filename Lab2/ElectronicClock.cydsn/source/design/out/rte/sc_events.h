 ...
 *
 **/
inline RC_t RTE_SC_EVENTS_init( SC_EVENTS_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_EVENTS_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_EVENTS_t * const signal: Pointer to the signal object
 * @return sc_events_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_EVENTS_data_t* RTE_SC_EVENTS_getPtr( SC_EVENTS_t * const signal )
{               
